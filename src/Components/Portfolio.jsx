          ...
          >
            ...
            <div className="mx-2 my-3 flex flex-col justify-center text-center">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="font-bold px-4 py-2 rounded border-[1px] hover:scale-105 my-2 transition-transform"
              >
                Source Code
              </a>
              {live.trim() === "" ? (
                <Link
                  to="/notLive"
                  className="font-bold px-4 py-2 rounded border-[1px] hover:scale-105 transition-transform"
                >
                  Live Link
                </Link>
              ) : (
